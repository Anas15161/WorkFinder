                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if($category->created_at)
                                                <span class="badge badge-secondary">{{ $category->created_at->format('F j, Y, g:i a') }}</span>
                                            @else
                                                <span class="badge badge-secondary">Creation date not available</span>
                                            @endif
                                        @else
                                            <span class="badge badge-secondary">Category not found</span>
                                        @endif
